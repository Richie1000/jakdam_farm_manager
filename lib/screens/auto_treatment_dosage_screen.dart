...
class AutoTreatmentDosageScreen extends StatefulWidget {
  @override
  _AutoTreatmentDosageScreenState createState() => _AutoTreatmentDosageScreenState();
}
...
class _AutoTreatmentDosageScreenState extends State<AutoTreatmentDosageScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Auto Treatment Dosage', style: TextStyle(color: Colors.black),),
        leading: IconButton(
  ...
  Widget buildMeasurementField(String label, double initialValue, Function(String) onChanged) {
    return Padding(
