...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final List<Map<String, dynamic>> _onboardingData = [
    {
      ...
      'description': 'Keep track of fish health, pond conditions, and stock levels in one place for a healthy produce.',
      'lottieFile': 'assets/animations/ab.json', // Lottie file for fish farm
    },
    {
      'title': 'Monitor Water Quality',
      'description': 'Ensure optimal water conditions with our easy-to-use monitoring tools.',
      'lottieFile': 'assets/animations/ac.json', // Lottie file for water quality
    },
    {
      'title': 'Boost Productivity',
      'description': 'Increase efficiency with task scheduling, feed management, and more!',
      'lottieFile': 'assets/animations/selling.json', // Lottie file for productivity
    },
  ];
  ...
  void _navigateToLogin(BuildContext context) {
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (ctx) => NewLoginScreen()), // Replace with login screen
    );
  }
        ...
        children: [
          ...
          Positioned(
            ...
            child: ElevatedButton(
              ...
              child: Text(
                _currentPage == _onboardingData.length - 1 ? 'Get Started' : 'Skip',
